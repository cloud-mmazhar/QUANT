<%@ Page Language="C#" MasterPageFile="~/Order/OrderMaster.master" AutoEventWireup="true" CodeFile="HAWB_Imp_List.aspx.cs" Inherits="Order_HAWB_Imp_List" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="pagetitle" ><span id="pagetitle">HAWB IMPORT</span></div>   
                        ...
                        <div id="dlg" class="panel" style="width:1000px">
                            ...
                            <div class="body">
                                <div class="outer">
                                    <div class="inner">
                                        <div class="content">
                                            <asp:ListView ID="lvHAWB" runat="server" onprerender="lvHAWB_PreRender">
                                                <LayoutTemplate>
                                                    <table id="customers" runat="server" class="grid" cellspacing="0" border="0">
                                                        ...
                                                        <tr class="pager" >
                                                            <td colspan="17">
                                                <div class="container">
                                                    <asp:DataPager ID="pager" PagedControlID="lvHAWB" runat="server" PageSize="20">
                                                        <Fields>
                                                ...
                                                <ItemTemplate>
                                                    <tr id="row" runat="server" class='<%# Container.DataItemIndex % 2 == 0 ? "row" : "altrow" %>'>
                                                       <td class="first"> <%# Eval("HAWB_ImpID")  %></td>
                                                       <td>
                                                       <a href='HAWB_Imp_Detail.aspx?HAWB_ImpID=<%# Eval("HAWB_ImpID") %>' > <%# Eval("HAWB_No") %> </a> 
                                                       </td>
                                                       <td><%# Eval("RefNo")   ?? "&nbsp;" %></td>
