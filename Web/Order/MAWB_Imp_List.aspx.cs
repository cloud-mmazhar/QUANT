...
public partial class Order_MAWB_Imp_List : System.Web.UI.Page
{
    ...
    {
        lvMAWB.DataSource = OrderAccess.GetAll_MAWB_Imp(); 
        lvMAWB.DataBind();
    }

    protected void lvMAWB_PreRender(object sender, EventArgs e)
    {
        //BindListView();
        BindData();
    }
