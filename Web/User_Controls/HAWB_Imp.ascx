<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HAWB_Imp.ascx.cs" Inherits="User_Controls_HAWB_Imp" %>
<%@ OutputCache Duration="360" VaryByParam="None" %>                                                                                               0
...
<div class="body1">
    ...
    Flight No.  :
    <asp:TextBox ID="txtFlight_No" runat="server"></asp:TextBox>
    <br />
    Final Destination : 
    ...
    <br /><br />
    <asp:Button ID="btnHAWB_Edit" runat="server" Text="Edit HAWB IMP"  />
    <br />
